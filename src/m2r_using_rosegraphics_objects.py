...
#            RENDER WILL DRAW ALL THE OBJECTS ON THE WINDOW
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            METHOD IS NECESSARY WHEN YOU WANT TO CHANGE FROM ONE WINDOW TO THE NEXT
#            BUT WANT TIME TO LOOK AT THE DRAWING BEFORE IT CHANGES
#
