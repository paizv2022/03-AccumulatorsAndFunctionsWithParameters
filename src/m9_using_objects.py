...
def two_circles():
    ...
    circle2 = rg.Circle(rg.Point(200, 200), 30)
...
def circle_and_rectangle():
    ...
    window = rg.RoseWindow()
    circle = rg.Circle(rg.Point(50, 50), 40)
    circle.fill_color = 'blue'
    rectangle = rg.Rectangle(rg.Point(150, 10), rg.Point(300, 200))
    circle.attach_to(window)
...
def lines():
    ...
    line1 = rg.Line(rg.Point(1, 1), rg.Point(125, 125))
    line2 = rg.Line(rg.Point(140, 140), rg.Point(265, 265))
    line2.thickness = 5
